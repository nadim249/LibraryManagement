...
public class It4 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public It4(){
        ...
        bookname=new JLabel("Name: Cyber Security Beginners");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Lucas Glisson");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 1114");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/it4.jpg");
