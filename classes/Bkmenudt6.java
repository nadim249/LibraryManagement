...
public class Bkmenudt6 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Bkmenudt6(){
        ...
        bookname=new JLabel("Name: Intro with Python");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Dr.S.S.Pansambal");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2006");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/bookspic/bkmdt2.jpg");
