...
public class Pg4 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Pg4(){
        ...
        bookname=new JLabel("Name: Computer Programming");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Alexander Bell");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2224");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/p4.jpg");
