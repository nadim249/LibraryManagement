...
public class Eeeb2 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Eeeb2(){
        ...
        bookname=new JLabel("Name:Electrical Machine Design");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName:A Nagoor Kani");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 3332");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/e2.jpg");
