...
public class It1 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public It1(){
        ...
        bookname=new JLabel("Name: Cyber Security Management");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Peter R.J. Trim");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 1111");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/it1.jpg");
