...
public class Ot4 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Ot4(){
        ...
        bookname=new JLabel("Name: Little women");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Louisa M.Alcott");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 4444");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/ot4.jpg");
