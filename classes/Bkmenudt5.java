...
public class Bkmenudt5 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Bkmenudt5(){
        ...
        bookname=new JLabel("Name: Power System An.");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: A.N.Kani");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2005");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/bookspic/bkmdt1.jpg");
