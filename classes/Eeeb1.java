...
public class Eeeb1 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Eeeb1(){
        ...
        bookname=new JLabel("Name: Basic Electricity");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: es.Bureau");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 3331");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/e1.jpg");
