...
public class Bkmenudt2 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Bkmenudt2(){
        ...
        namefont=new Font("Cambria",Font.PLAIN,20);
        buttoncolor=new Color(132, 203, 243);
		
        bookname=new JLabel("Name:Computer Aided  E Drawing");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: M.Yogesh");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2002");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/bookspic/bkmdt6.jpg");
