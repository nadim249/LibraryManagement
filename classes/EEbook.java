...
public class EEbook extends JFrame implements MouseListener,ActionListener{
    JPanel panel;
   ...
   if(ae.getSource()==backbtn)
   {
    ...
    {
		Eeeb2 bkm1=new Eeeb2();
		bkm1.setVisible(true);
		this.setVisible(false);
    }
    else if(ae.getSource()==dt3)
    {
		Eeeb3 bkm1=new Eeeb3();
		bkm1.setVisible(true);
		this.setVisible(false);
    }
    else if(ae.getSource()==dt4)
    {
		Eeeb4 bkm1=new Eeeb4();
		bkm1.setVisible(true);
		this.setVisible(false);
