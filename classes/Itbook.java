...
public class Itbook extends JFrame implements MouseListener,ActionListener{
    JPanel panel;
    ...
    public Itbook(){
		...
		book1=new ImageIcon("images/it.png");
