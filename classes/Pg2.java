...
public class Pg2 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Pg2(){
        ...
        bookname=new JLabel("Name: Programming with C");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: T Jeyapoovan");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2222");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/p2.jpg");
