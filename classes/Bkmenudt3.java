...
public class Bkmenudt3 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Bkmenudt3(){
        ...
        bookname=new JLabel("Name: IT & Emvironment");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Binu M.B");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2003");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/bookspic/bkmdt4.jpg");
