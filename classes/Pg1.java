...
public class Pg1 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Pg1(){
        ...
        bookname=new JLabel("Name: Python Programming");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Andrew Burn");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2221");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/p1.jpg");
