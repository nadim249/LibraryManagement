...
public class Ot1 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Ot1(){
        ...
        bookname=new JLabel("Name: Invisible Man");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Ralph Ellison");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 4441");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/ot1.jpg");
