...
public class Eeeb3 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Eeeb3(){
        ...
        bookname=new JLabel("Name: Circut Theory");
        ...
        bookname=new JLabel("Book ID: 3333");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/e3.png");
