...
public class Eeeb4 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Eeeb4(){
        ...
        bookname=new JLabel("Name: Electrical Apparatus");
        ...
        bookname=new JLabel("Book ID: 3334");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/e4.jpg");
