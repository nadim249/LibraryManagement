...
public class Bkmenudt4 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Bkmenudt4(){
        ...
        bookname=new JLabel("Name: Core Java");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Cay S. Horstmann");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2004");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/bookspic/bkmdt3.jpg");
