...
public class It2 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public It2(){
        ...
        bookname=new JLabel("WriterName: Peter R.J. ");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 1112");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/it2.png");
