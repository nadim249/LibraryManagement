...
public class Ot3 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Ot3(){
        ...
        bookname=new JLabel("Name: The Catcher");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: J.D. Salinger");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 4443");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/ot3.jpg");
