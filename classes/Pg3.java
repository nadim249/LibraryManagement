...
public class Pg3 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Pg3(){
        ...
        bookname=new JLabel("WriterName: Julian Jemes");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 2223");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/p3.jpg");
