...
public class Ot2 extends JFrame implements MouseListener,ActionListener
 {
    JPanel panel;
    ...
    public Ot2(){
        ...
        bookname=new JLabel("Name: Letters of Passion");
        bookname.setBounds(450,130,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("WriterName: Elisabeth williamson");
        bookname.setBounds(450,190,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);
		
        bookname=new JLabel("Book ID: 4442");
        bookname.setBounds(450,260,330,50);
		bookname.setFont(namefont);
        panel.add(bookname);

        logo1=new ImageIcon("images/ot2.jpg");
